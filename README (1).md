...
<html lang="en">
  ...
  <title>lattice_planner/README.md at master · marinaKollmitz/lattice_planner</title>
  <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
  <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
  <meta property="fb:app_id" content="1401488693436528">

    
    <meta content="https://avatars2.githubusercontent.com/u/7736948?s=400&amp;v=4" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="marinaKollmitz/lattice_planner" property="og:title" /><meta content="https://github.com/marinaKollmitz/lattice_planner" property="og:url" /><meta content="The lattice_planner package provides a move_base global planner plugin for a time-bounded A* lattice planner. The planner is designed to plan time dependent, dynamically feasible navigation paths f..." property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjIzNjQ4OTM1OjgwYWFlMTJkMjFlZGM1Y2M1ZWM3NDE3ZGJmOTI4YThjOWYwYzcxODJmYzMwNzIyMjlkZjVkMGEyZWVkODNlMWM=--01347ad0af4d5eb3ed3ab55b64cee7a8e25dcf77">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="E362:23E1:706204:C4DB7F:5A1213FD" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="andresvasquezv">
    ...
    <meta name="js-proxy-site-detection-payload" content="MTE2OGI3ZmQ5ODM1YmI4YjI1NTk5NzRmMGRmOGZmMTMzODJjMDE3ZWVkYTQ1MzFiMTMzOTA2YWE3OTg5MWIxNnx7InJlbW90ZV9hZGRyZXNzIjoiODkuMTIuMjE5LjQ4IiwicmVxdWVzdF9pZCI6IkUzNjI6MjNFMTo3MDYyMDQ6QzREQjdGOjVBMTIxM0ZEIiwidGltZXN0YW1wIjoxNTExMTM0MjA1LCJob3N0IjoiZ2l0aHViLmNvbSJ9">

    <meta name="enabled-features" content="UNIVERSE_BANNER,FREE_TRIALS">

  <meta name="html-safe-nonce" content="c4b66d03b95773d03e009b77ad375ab72bdffe74">

  <meta http-equiv="x-pjax-version" content="3dd2cf38c13e0efbbb8852c70ba1761d">
  

      <link href="https://github.com/marinaKollmitz/lattice_planner/commits/master.atom" rel="alternate" title="Recent Commits to lattice_planner:master" type="application/atom+xml">

  <meta name="description" content="The lattice_planner package provides a move_base global planner plugin for a time-bounded A* lattice planner. The planner is designed to plan time dependent, dynamically feasible navigation paths for robots with differential drive constraints. It uses a dynamic cost map which is based on the ROS costmap representation from the costmap_2d package.">
  <meta name="go-import" content="github.com/marinaKollmitz/lattice_planner git https://github.com/marinaKollmitz/lattice_planner.git">

  <meta content="7736948" name="octolytics-dimension-user_id" /><meta content="marinaKollmitz" name="octolytics-dimension-user_login" /><meta content="38316337" name="octolytics-dimension-repository_id" /><meta content="marinaKollmitz/lattice_planner" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="38316337" name="octolytics-dimension-repository_network_root_id" /><meta content="marinaKollmitz/lattice_planner" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />


    <link rel="canonical" href="https://github.com/marinaKollmitz/lattice_planner/blob/master/README.md" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/marinaKollmitz/lattice_planner/search" class="js-site-search-form" data-scoped-search-url="/marinaKollmitz/lattice_planner/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/marinaKollmitz/lattice_planner/blob/master/README.md" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-channel="notification-changed:16100247" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@andresvasquezv" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/16100247?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">andresvasquezv</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/andresvasquezv" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/andresvasquezv?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="jHwsht6ms+QrLXdeKefcC0vPonAVY2ZXycJJjqFPvShgDiAVJBgz0OZR/kAVJTn757f/EWQqUJAicXklkQv3Bg==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="GqRhd4NS26ic6HmmJhYNJsFlViSJwIGTGx0IAUICdgb21m3keexbnFGU8Lga1OjWbR0LRfiJt1TwrjiqckY8KA==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="kuD/dJJlB18fgly/Kmi2Z63Lhc7+ngFegnfKEOG7/9RFGhNl6O3dVmocTzWS3GczqkatY22QRVJDnjYA9TkEJw==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="38316337" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/marinaKollmitz/lattice_planner/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="q6EVDQ0Dzk+7exe5BHcBxybUMW7vPXMY8wvjLlCxjzbnydki1NSSQ4OxjujnzesbuugLNiThEDBE0SWKixmnbg==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/marinaKollmitz/lattice_planner/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="CDvLpsg8yexBcon7JdYhOLpX3Ha23+LzGR4qUiO2/dgbXVQq2nlzvmPafp0VMjyxLBs5VOHlTXPZZiSafoQoow==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/marinaKollmitz/lattice_planner/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Ab/jTxrx3tIuchEdIrsWGh+NoBMbKjBwU/UvgnjjHVWAeIaYvyeC/UA/v01ddI7j1m55ilnX9dnd3cjXPtjFYw==" /></div>
            <button
                type="submit"
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/marinaKollmitz/lattice_planner/commit/f9cf2bde34584bfa965a02dcf34665a80203f0e3" data-pjax>
          f9cf2bd
        </a>
        <relative-time datetime="2015-08-06T15:02:14Z">Aug 6, 2015</relative-time>
      </span>
      <div>
        <img alt="@marinaKollmitz" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/7736948?s=40&amp;v=4" width="20" />
        <a href="/marinaKollmitz" class="user-mention" rel="author">marinaKollmitz</a>
          <a href="/marinaKollmitz/lattice_planner/commit/f9cf2bde34584bfa965a02dcf34665a80203f0e3" class="message" data-pjax="true" title="corrected mixup in readme and mainpage doc files">corrected mixup in readme and mainpage doc files</a>
      </div>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@marinaKollmitz" height="24" src="https://avatars3.githubusercontent.com/u/7736948?s=48&amp;v=4" width="24" />
            <a href="/marinaKollmitz">marinaKollmitz</a>
          </li>
      </ul>
    </div>
  </div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/marinaKollmitz/lattice_planner/commits/master/README.md" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/marinaKollmitz/lattice_planner/edit/master/README.md" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="eMjMnUDf8jiw1/6utKULMSJe8M8wRkrUhikf4tO0pQc3mc58hHT2CUEoRxk0JHCZg92aF2uMb5zIwp/JBKhcNw==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/marinaKollmitz/lattice_planner/delete/master/README.md" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="PTbY7j6C31WT4FDpYfIV9xGIth4u1mmYkTtutZXjyUOcbQep3/PrsOX9Q+UNBhcNLYhiXawrPFWc6cpqo2NFNQ==" /></div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.15041s from unicorn-100123894-n3p03">GitHub</span>, Inc.</li>
